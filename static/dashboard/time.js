...
/*
function getFormattedDateLocal(tms){
    return moment.utc(tms*1000).format('YYYY-MM-DD HH:mm:ss Z');
}
*/

function getFormattedDateLocal(tms){
    var offset = ((new Date()).getTimezoneOffset()*60*1000)*-1;
    var utc_dt_obj = new Date(tms*1000 - offset);
    var dtobj = new Date(utc_dt_obj.getTime() + offset);
    var dstr;
    var date_str_rep = dtobj.toString();
    ...
    dstr = dtobj.getFullYear() + 
        ...
        ':' + (dtobj.getSeconds() < 10 ? '0'+dtobj.getSeconds() : dtobj.getSeconds() )+ ' ' + tz;
    return dstr;
}
...
function getFormattedDateUTC(tms){
    var offset = ((new Date()).getTimezoneOffset()*60*1000)*-1;
    var dtobj = new Date(tms*1000 - offset);
    var dstr;
    dstr = dtobj.getFullYear() + 
        '-' + (dtobj.getMonth() < 9 ? '0'+ (dtobj.getMonth()+1) : (dtobj.getMonth()+1) ) + 
        '-' + (dtobj.getDate() < 10 ? '0'+dtobj.getDate() : dtobj.getDate() )  + 
        ' ' + (dtobj.getHours() < 10 ? '0'+dtobj.getHours() : dtobj.getHours() ) +
        ':' + (dtobj.getMinutes() < 10 ? '0'+dtobj.getMinutes() : dtobj.getMinutes() ) +
        ':' + (dtobj.getSeconds() < 10 ? '0'+dtobj.getSeconds() : dtobj.getSeconds() )+ ' UTC';
    return dstr;
}
...
/*function getFormattedDateUTC(tms){
    ...
    var dstr;
    dstr = dtobj.getUTCFullYear() + 
        '-' + (dtobj.getUTCMonth() < 9 ? '0'+ (dtobj.getUTCMonth()+1) : (dtobj.getUTCMonth()+1) ) + 
        '-' + (dtobj.getUTCDate() < 10 ? '0'+dtobj.getUTCDate() : dtobj.getUTCDate() )  + 
        ' ' + (dtobj.getUTCHours() < 10 ? '0'+dtobj.getUTCHours() : dtobj.getUTCHours() ) +
        ':' + (dtobj.getUTCMinutes() < 10 ? '0'+dtobj.getUTCMinutes() : dtobj.getUTCMinutes() ) +
        ':' + (dtobj.getUTCSeconds() < 10 ? '0'+dtobj.getUTCSeconds() : dtobj.getUTCSeconds() )+ ' UTC';
    return dstr;
}*/
